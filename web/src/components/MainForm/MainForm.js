...
const MainForm = () => {
  ...
  const [cornerPicture, setCornerPicture] = useState({
    ...
    url: `https://res.cloudinary.com/dize5fvu6/image/upload/v1602168983/Unfolded/unfolded_logo.jpg`,
    opacity: 70,
  ...
  const onSubmit = (data, e) => {
    ...
    if (!data.mainPicture[0]) {
      addMessage('No Main Picture selected')
      return
    }
    if (!data.cornerPicture[0] && !cornerPicture.id) {
    ...
    if (!mainPic || data.mainPicture[0].name != mainPic.name)
          ...
          <div className="border-b border-gray-300 ">
            <div className="px-4 py-5 sm:px-6 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              ...
              <div>
                ...
                <div className="flex py-2">
                  <label htmlFor="innerBorderEnabled" className="text-gray-500">
                    Enabled
                  </label>
                ...
                <div className="flex border-t border-gray-300 py-2">
                  <label htmlFor="innerBorderSize" className="text-gray-500">
                    Size
                  </label>
                  <NumberField
                    id="innerBorderSize"
                    ...
                    className="ml-auto bg-gray-200 rounded-sm hover:bg-gray-300 appearance-none w-16"
                    disabled={!innerBorder.enabled}
                  />
                </div>

                <div className="flex border-t border-gray-300 py-2">
                  <label htmlFor="innerBorderColor" className="text-gray-500">
                    Color
                  </label>
                  <div
                    id="innerBorderColor"
                ...
                <div>
                  ...
                  <div className="flex border-t border-gray-300 py-2">
                    <label htmlFor="mainBorderSize" className="text-gray-500">
                      Size
                    </label>
                    <NumberField
                      id="mainBorderSize"
                  ...
                  <div className="flex border-t border-gray-300 py-2">
                    <label htmlFor="mainBorderColor" className="text-gray-500">
                      Color
                    </label>
                    <div
                      id="mainBorderColor"
                ...
                <div>
                  ...
                  <div className="flex border-t border-gray-300 py-2">
                    <label htmlFor="outerBorderSize" className="text-gray-500">
                      Size
                    </label>
                    <NumberField
                      id="outerBorderSize"
                      ...
                      className="ml-auto bg-gray-200 rounded-sm hover:bg-gray-300 appearance-none appearance-textfield w-16"
                      disabled={!outerBorder.enabled}
                    />
                  </div>

                  <div className="flex border-t border-gray-300 py-2">
                    <label htmlFor="outerBorderColor" className="text-gray-500">
                      Color
                    </label>
                    <div
                      id="outerBorderColor"
